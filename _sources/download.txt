...
<http://www.brainnetome.org/dmri/MRDiffusionSetup_WIN64-v1.1.0.exe>`_

|winlogo| `Windows Installer (x86) 
<http://www.brainnetome.org/dmri/MRDiffusionSetup_WIN32-v1.1.0.exe>`_

|rellogo| `Linux Binary Package (x86) 
<http://www.brainnetome.org/dmri/MRDiffusionSetup_Linux_x86-64-v1.1.0.tar.gz>`_
